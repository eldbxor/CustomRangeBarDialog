...
public class CustomPinView extends View {
    // Private Constants ///////////////////////////////////////////////////////
    ...
    public void draw(Canvas canvas) {
        ...
        if (mPinRadiusPx > 0 && (mHasBeenPressed || !mPinsAreTemporary)) {
            ...
            canvas.drawText(text,
                    ...
                    mTextPaint);
        } else if (mPinRadiusPx == 0) {
            mBounds.set((int) mX - (int) mCircleRadiusPx,
                    (int) mY - (int) mCircleRadiusPx,
                    (int) mX + (int) mCircleRadiusPx, (int) mY - (int) mCircleRadiusPx);
            ...
            mTextPaint.getTextBounds(text, 0, text.length(), mBounds);
            mTextPaint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText(text, mX, mY + (int) (mCircleRadiusPx / 4), mTextPaint);
        }
        super.draw(canvas);
    }
